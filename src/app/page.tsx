...
export default function HomePage() {
  return <>
    ...
    <section className="section" style={{paddingTop: 0}}><div className="container"><div className="section-heading"><div><p className="eyebrow">Current needs</p><h2>Featured appeals</h2></div><Link href="/appeals">View all appeals →</Link></div><div className="grid appeal-grid">{appeals.map(appeal => <AppealCard key={appeal.slug} appeal={appeal} />)}</div></div></section>
