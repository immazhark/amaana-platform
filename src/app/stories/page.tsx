    ...
    <div className="v2-home v2-stories-page">
      <section className="v2-stories-hero">
        <div className="v2-shell v2-stories-hero-grid">
          <div className="v2-stories-hero-copy">
            <p className="v2-section-label">Stories of Amanah · field journal</p>
            <h1>Where the work becomes a story.</h1>
            <p>Completed assistance, field notes and campaign moments are published only when the record is ready to be shared with dignity. Known outcomes stay distinct from assumptions.</p>
            <div className="v2-hero-actions"><a className="v2-button" href="#journal">Enter the journal</a><Link className="v2-text-link" href="/our-work">Explore the work →</Link></div>
          </div>
      ...
      <section className="v2-section paper v2-stories-archive">
        <div className="v2-shell">
          ...
          {remainingStories.length > 0 ? (
            ...
            <div className="v2-stories-single-note"><span>Archive beginning</span><p>More privacy-approved field stories will join this journal as their records are published.</p></div>
          ) : (
            <div className="v2-reminder v2-light-reminder"><span className="v2-reminder-label">Privacy gate active</span><h3>No public stories are available yet.</h3><p>A story remains private until both publication review and privacy approval are complete. Nothing is invented simply to make the archive look populated.</p><Link className="v2-text-link" href="/our-work">Explore published initiatives →</Link></div>
          )}
        </div>
      </section>

      <section className="v2-section dark v2-stories-ethic">
        <div className="v2-shell v2-stories-ethic-grid">
          <div><p className="v2-section-label">Editorial ethic</p><h2 className="v2-section-title">Dignity comes before visibility.</h2><p className="v2-section-intro">Amaana&apos;s public storytelling exists to explain the work, not to turn vulnerability into content.</p></div>
          <div className="v2-stories-ethic-list"><article><span>01</span><h3>Share only what is approved</h3><p>Stories and media pass separate publication and privacy gates.</p></article><article><span>02</span><h3>Keep private proofs private</h3><p>Identity documents, medical records and sensitive verification material do not belong in the public story.</p></article><article><span>03</span><h3>Separate fact from inference</h3><p>Known outcomes can be published. Assumed recovery, need fulfilment or personal circumstances cannot.</p></article></div>
        </div>
      </section>
