  ...
  return <div className="v2-home v2-donate-page">
    <section className="v2-donate-hero">
      <div className="v2-shell v2-donate-hero-grid">
        ...
        <aside className="v2-donate-context" aria-label="Donation context">
          ...
          <dl><div><dt>Type</dt><dd>{appeal.category.replaceAll("_", " ")}</dd></div>{appeal.beneficiaryLocation && <div><dt>Location</dt><dd>{appeal.beneficiaryLocation}</dd></div>}<div><dt>Remaining need</dt><dd>{formatINR(remainingAmount)}</dd></div><div><dt>Contribution</dt><dd>Domestic INR only</dd></div></dl>
        </aside>
      </div>
    </section>
    ...
    <section className="v2-section paper v2-donate-form-section" aria-labelledby="donation-form-heading">
      <div className="v2-shell v2-donate-layout">
        ...
        <div><DonationForm appealId={appeal.id} appealTitle={appeal.title} maxAmount={remainingAmount}/></div>
      </div>
    </section>
