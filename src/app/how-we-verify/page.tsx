...
export default function VerificationPage() {
  return <div className="v2-home v2-verify-page">
    ...
    <section className="v2-closing"><div className="v2-shell"><p className="v2-section-label">From verification to evidence</p><h2>Trust should remain visible after the appeal is published.</h2><p>Continue into Amaana&apos;s transparency approach to see how public evidence, updates and privacy boundaries fit together.</p><div className="v2-hero-actions" style={{justifyContent:"center"}}><Link className="v2-button" href="/transparency">Explore transparency</Link><Link className="v2-text-link" href="/appeals">View appeals →</Link></div></div></section>
  </div>;
}
