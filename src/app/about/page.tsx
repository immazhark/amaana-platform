    ...
    <div className="v2-home">
        ...
        <div className="v2-shell v2-hero-inner">
          ...
          <div>
            <p className="v2-hero-copy">
              Amaana began during Ramadan 2020, when a family response to a difficult time grew through the generosity of relatives, friends and the wider community.
            </p>
      ...
      <section className="v2-origin v2-section">
        <div className="v2-shell">
          ...
          <p>
            In 2020, the hardship created by the pandemic was being felt across Hyderabad. During Ramadan, the family behind Amaana wanted less-fortunate households to be able to prepare for Eid with greater ease and dignity. What began as a family-funded effort was shared with relatives and friends, and the response enabled the first Eid Kits distribution to reach 85 families.
          </p>
        </div>
      </section>
      ...
      <section className="v2-section dark">
        <div className="v2-shell">
          <div className="v2-section-head">
            <div>
              <p className="v2-section-label">From one Ramadan onward</p>
              <h2 className="v2-section-title">The work kept growing because people kept trusting it.</h2>
            </div>
            <p className="v2-section-intro">
              Eid Kits continued year after year, while the work expanded into seasonal relief, education support, emergency response, medical and financial assistance, dates distribution and Qurbani meat distribution. As the responsibility grew, the effort was formalised as Amaana Foundation so the work could continue with clearer accountability and structure.
            </p>
          </div>
      ...
      <section className="v2-section paper">
        <div className="v2-shell">
          <div className="v2-section-head">
            <div>
              <p className="v2-section-label">What guides the work</p>
              <h2 className="v2-section-title">Faith. Dignity. Action.</h2>
            </div>
            <p className="v2-section-intro">
              Islamic faith is part of Amaana&apos;s origin and motivation. Service should protect dignity, generosity should be handled as a trust, and public communication should never exaggerate an outcome or expose private hardship for effect.
            </p>
          </div>
      ...
      <section className="v2-section">
        <div className="v2-shell v2-faith-grid">
          <div>
            ...
            <p className="v2-section-intro">
              Requests are received, relevant supporting information is reviewed, genuine needs are assessed, and approved work may become an assistance case, initiative or public appeal. Internal software roles and approval mechanics stay behind the scenes; visitors should see the mission, the process and the evidence.
            </p>
            <div className="v2-hero-actions">
              <Link className="v2-button" href="/how-we-verify">How Amaana works</Link>
          ...
          <div className="v2-reminder" style={{ color: "var(--v2-ink)", borderColor: "rgb(15 27 43 / 12%)", background: "#fffdf8" }}>
            <span className="v2-reminder-label" style={{ color: "var(--v2-gold)" }}>Public team information</span>
            <h3 style={{ marginTop: "1rem" }}>Team and governance will be presented separately.</h3>
            <p style={{ color: "#68717a" }}>
              Public names, roles, photographs and biographies will be added only from the approved team material. Legal trusteeship will not be confused with internal website administration roles.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="v2-closing">
        <div className="v2-shell">
          ...
          <div className="v2-hero-actions" style={{ justifyContent: "center" }}>
            ...
            <Link className="v2-text-link" href="/impact">See the impact →</Link>
          </div>
        </div>
      </section>
    </div>
