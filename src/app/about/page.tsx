...
export default function Page(){return <CanonicalArticle eyebrow="Amaana Foundation · Hyderabad" heroVariant="level1" heroVisualTitle="Our Story" heroVisualNote="From community-led Ramadan support to a registered charitable trust serving verified needs with dignity and accountability." {...aboutCopy}><section className="canonical-block"><h2>Recognition from AMP</h2><div><p>Amaana Foundation received the Best NGO Award of the Year (Telangana) at AMP’s 5th National Awards for Social Excellence 2025.</p><Link href="/recognition">View the Certificate of Excellence →</Link></div></section></CanonicalArticle>;}
