...
export default function Page(){
  return <CanonicalArticle eyebrow="Governance" heroVariant="trust" heroVisualTitle="Governance" bodyClassName="canonical-body--governance" bodyId="governance-record" heroActions={[{ label: "Meet the trustees", href: "#governance-record" }, { label: "Compliance position", href: "/compliance", secondary: true }]} pathways={[
      { label: "How verification works", href: "/how-we-verify", description: "See how requests move from private evidence and review to responsible action." },
      { label: "Transparency & reporting", href: "/transparency", description: "Understand what Amaana publishes, what remains private and why." },
      { label: "Compliance position", href: "/compliance", description: "Review the Foundation’s current registration, donation and tax-document boundaries." },
    ]} {...governanceCopy}>
