...
export default async function AppealDetailPage({ params }: Props) {
  ...
  return (
    <div className="v2-home v2-appeal-detail-page">
      ...
      <section className="v2-closing"><div className="v2-shell"><p className="v2-section-label">Continue with context</p><h2>See the work around the appeal.</h2><p>Explore completed initiatives, documented outcomes and Amaana&apos;s public evidence approach before or after contributing.</p><div className="v2-hero-actions" style={{ justifyContent: "center" }}><Link className="v2-button" href="/our-work">Explore our work</Link><Link className="v2-text-link" href="/transparency">Transparency →</Link></div></div></section>
    </div>
  );
}
