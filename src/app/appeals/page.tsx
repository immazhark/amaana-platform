      ...
      <section className="v2-appeals-hero" aria-labelledby="appeals-hero-title">
        <div className="v2-shell v2-appeals-hero-grid">
          <div>
            ...
            <h1 id="appeals-hero-title">Verified Needs. Clear Purpose. Responsible Support.</h1>
            <p>Amaana’s public appeals are created for specific needs that have been reviewed before fundraising. Each appeal explains what support is required, what donations will be used for, the campaign status, and—once completed—the documented outcome.</p>
