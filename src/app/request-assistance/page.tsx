...
export default function RequestAssistancePage() {
  return <div className="v2-home v2-assistance-page">
    <section className="v2-assistance-hero"><div className="v2-shell v2-assistance-hero-grid"><div><p className="v2-section-label">A private first step</p><h1>Asking for help<br />should preserve<br /><em>dignity.</em></h1><p>Tell Amaana what is happening and what support is being sought. Your request begins privately with review — not as a public fundraising page.</p><a className="v2-button" href="#request-form">Begin your request</a></div><div className="v2-assistance-promise"><span>What happens here</span><strong>Private request</strong><i>↓</i><strong>Human review</strong><i>↓</i><strong>Verification</strong><i>↓</i><strong>Responsible decision</strong><p>Submission does not guarantee assistance or publication.</p></div></div></section>
