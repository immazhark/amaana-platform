...
export default function Page(){return <CanonicalArticle eyebrow="Transparency" heroVariant="trust" heroVisualTitle="Transparency" bodyClassName="canonical-body--comparison" bodyId="transparency-record" heroActions={[{ label: "How accountability works", href: "#transparency-record" }, { label: "Compliance position", href: "/compliance", secondary: true }]} {...transparencyCopy}></CanonicalArticle>;}
