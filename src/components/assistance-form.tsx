...
export function AssistanceForm() {
  ...
  return <form className={`v2-premium-form v2-assistance-form ${styles.form}`} onSubmit={submit} encType="multipart/form-data" aria-busy={submitting} aria-labelledby="assistance-form-heading" aria-describedby="assistance-form-description">
