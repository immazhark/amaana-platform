...
const initiatives = [
  ...
  },
  {
    ...
    title: "A Livelihood on Wheels",
    summary: "Sometimes the most meaningful assistance is not temporary relief, but the means to move forward independently. Through the collective support of our donors, ₹95,000 was raised to help provide an auto-rickshaw and essential start-up support—creating an opportunity for sustained income, greater stability, and a more dignified path forward.",
    story: "Sometimes the most meaningful assistance is not temporary relief, but the means to move forward independently. Through the collective support of our donors, ₹95,000 was raised to help provide an auto-rickshaw and essential start-up support—creating an opportunity for sustained income, greater stability, and a more dignified path forward.",
    primaryMetric: "₹95,000",
    primaryMetricLabel: "raised toward this case",
    displayOrder: 6,
    causeSlug: "medical-financial-relief",
  },
  {
